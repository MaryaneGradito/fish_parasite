...
sex <- test[,2,"logactivity_treatmentE"]
  ...
  plot(y~x, xlab = "Slope for Activity", ylab = "log Mean Boldness", pch = 2, ylim = c(-0.5, 1), xlim=c(-1.2, 1)) 
  ...
  #Compare model 4 and 6 (only thing that changed was body condition)
  loo(model4 ,model6) #model 6 better but they are really close
