...
###################
#plot model2      
all_data_T$treatment <- factor(all_data_T$treatment, levels=c("Uninfected","Infected", "Control"))
...
scale_color_manual(labels = c("Uninfected","Infected","Control"), values = c("#9A6FA5", "#6FA5A4","#FAFA8B"))+
...
geom_segment(aes(x = 1.5, xend = 2.5, y = -3.9, yend = -3.9), color = "black") +
annotate("text",  x = 2, y = -3.7, label = TeX(paste0("$Contrast_{U - I}$ = -0.47, $pMCMC_{\\alpha = 0.05}$ > 0.001***")), size =2.5) +
  geom_segment(aes(x = 2.5, xend = 3.5, y = 2.8, yend = 2.8), color = "black") +
annotate("text",  x = 3, y = 3, label = TeX(paste0("$Contrast_{U - C}$ = -1.11, $pMCMC_{\\alpha = 0.05}$ = 0.002**")), size =2.5)
...
geom_violin(aes(), trim = FALSE) +
geom_jitter(aes(colour = trt),shape=16, position=position_jitter(0.1)) +  scale_color_manual(labels = c("Uninfected","Infected","Control"), values = c("#9A6FA5", "#6FA5A4","#FAFA8B"))+
...
theme(legend.position = "none",
 legend.title = element_blank())+
geom_segment(aes(x = 1.5, xend = 2.5, y = 0.02, yend = 0.02), color = "black") +
annotate("text",  x = 2, y = 0.04, label = TeX(paste0("$Contrast_{U - I}$ = 0.42, $pMCMC_{\\alpha = 0.05}$ = 0.001**")), size =2.5) + 
 geom_segment(aes(x = 2.5, xend = 3.5, y = 0.53, yend = 0.53), color = "black") + 
annotate("text",  x = 3, y = 0.55, label = TeX(paste0("$Contrast_{U - C}$ = 1.13, $pMCMC_{\\alpha = 0.05}$ > 0.001**")), size =2.5) 
...
theme(legend.position = "none",
 legend.title = element_blank()) +
geom_segment(aes(x = 1.5, xend = 2.5, y = -3.4, yend = -3.4), color = "black") +
annotate("text",  x = 2, y = -3.2, label = TeX(paste0("$Contrast_{U - I}$ = -0.26, $pMCMC_{\\alpha = 0.05}$ = 0.06")), size =2.5) + 
  geom_segment(aes(x = 2.5, xend = 3.5, y = 3, yend = 3), color = "black") + 
annotate("text",  x = 3, y = 3.2, label = TeX(paste0("$Contrast_{U - C}$ = -0.22, $pMCMC_{\\alpha = 0.05}$ = 0.341")), size =2.5)
...
```{r}
tab3 <- data.frame("Models" = c("Model 1", "Model 2","Model 3","Model 4"),
"Shyness" = c("shyness ~ 1 + treatment + (-1 + treatment |q| ID_fish) + (1|cage), sigma ~ -1 + treatment","shyness ~ 1 + body condition + (1|ID_fish) + (1|cage)","shyness ~ 1 + parasite density + body condition + (1|ID_fish) + (1|cage)",
"shyness ~ 1 + cestode density + black spot density + body condition + (1|ID_fish) + (1|cage)"),
"Activity" = c("activity ~ 1 + treatment + (-1 + treatment |q| ID_fish) + (1|cage), sigma ~ -1 + treatment",
"activity~ 1 + body condition + (1|ID_fish) + (1|cage)","activity ~ 1 + parasite density + body condition + (1|ID_fish) + (1|cage)",
"activity ~ 1 + cestode density + black spot density + body condition + (1|ID_fish) + (1|cage)"),
"Exploration" = c("exploration ~ 1 + treatment + (-1 + treatment |q| ID_fish) + (1|cage), sigma ~ -1 + treatment", "exploration~ 1 + body condition+ (1|ID_fish) + (1|cage)"," exploration ~ 1 + parasite density + body condition + (1|ID_fish) + (1|cage)",
