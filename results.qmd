...
#plot
 ...
 geom_smooth(data = act_bc_c_dat, ggplot2::aes(x = bc, y = raw_act_bc_c), method =  "loess", formula = y~x, se = FALSE,lty = "solid", color = "#6FA5A4", size=1) +
  ...
  geom_smooth(data = act_bc_c_dat, ggplot2::aes(x = bc, y = raw_act_U95), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#6FA5A4", size=0.8)+
   theme_classic() +
    draw_image("./img/no_parasite.png", x= 0.020,y = 1, scale = 0.8) +
...
x2<- ggplot(data=dat_parasite)+
 ...
 geom_smooth(data = act_bc_dat, ggplot2::aes(x = bc, y = raw_act_bc), method =  "loess", formula = y~x, se = FALSE,lty = "solid", color = "#9A6FA5", size=1) +
  ...
  geom_smooth(data = act_bc_dat, ggplot2::aes(x = bc, y = raw_act_U95), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#9A6FA5", size=0.8)+
   theme_classic() +
 draw_image("./img/parasite.png", x= 0.028,y = 1.7, scale = 0.8)+
    theme(strip.background = element_rect(fill = "white", colour = "white")) +
    theme(legend.position="none") + labs(x = TeX("Body condition (g/cm)"), y = TeX("$Activity_{log_{2}}$"), title = "")+
 annotate("text", x = 0.025, y = 1.7, label = TeX(paste0("$beta_{bc}$ = "," 0.25 ", " 95%CI: 0.09, 0.42**")), size=3, color = "black")
...
#################################
  ...
  #bs
  mean_bs<- mean(dat_parasite$dens_bs)
  sd_bs<- sd(dat_parasite$dens_bs)
  #cestode
...
pred_bs_brms <- posterior_epred(model7, re_formula = NA, newdata = newdat2)
  ...
  summ_boldU95_bs <- apply(boldness_bs, 2, function(x) quantile(x, 0.975))
   ...
   #raw units
  #for bs
  newdat2$bs<-(newdat2$z_bs * sd_bs) + mean_bs
  range(newdat2$bs)
...
#bold_pl_dat <- cbind(newdat5, summ_bold_pl, summ_boldL95_pl, summ_boldU95_pl)
 ...
 # pred_ces <- predict(model7, re_formula = NA, newdata = newdat)
  ...
  geom_smooth(data = boldness_ces_dat, ggplot2::aes(x = ces, y = raw_bold_ces_U95), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#9A6FA5", size=0.8) + 
    geom_point(mapping = aes(x = dens_bs, y = log_boldness), color = "#6FA5A4")+
 ...
 # geom_smooth(data = bold_pl_dat, ggplot2::aes(x = z_pl, y = summ_boldU95_pl), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#A2A2A2", size=0.8)+
   theme_classic() +
 draw_image("./img/blackspots.png", x = 28, y = -1.2, scale = 6)+
 draw_image("./img/cestodes.png", x = 28, y = -0.5, scale = 6) +
    theme(strip.background = element_rect(fill = "white", colour = "white")) +
    theme(legend.position="none") + labs(x = TeX(""), y = TeX("$Shyness_{log_{2}}$"), title = "") +
    annotate("text", x = 15, y = 1.6, label = TeX(paste0("$beta_{bs}$ = ", " -0.08 ", " 95%CI: -0.28, 0.12")), size =3, color = "#059687") + 
  annotate("text", x = 15, y = 1.8, label = TeX(paste0("$beta_{ces}$ = "," 0.10 ", " 95%CI: -0.11, 0.30")), size=3, color = "#8F05B3")
...
n2<-ggplot(data=dat_parasite)+
 ...
 geom_smooth(data = exp_ces_dat, ggplot2::aes(x = ces, y = raw_exp_ces), method =  "loess", formula = y~x, se = FALSE,lty = "solid", color = "#9A6FA5", size=1) +
  ...
  geom_point(mapping = aes(x = dens_bs, y = exploration), color = "#6FA5A4") +
  ...
  #geom_smooth(data = exp_pl_dat, ggplot2::aes(x = z_pl, y = summ_expU95_pl), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#A2A2A2", size=0.8)+
   theme_classic() +
 draw_image("./img/blackspots.png", x = 28, y = -0.16, scale = 6)+
  draw_image("./img/cestodes.png", x = 28, y = -0.22, scale = 6) +
    theme(strip.background = element_rect(fill = "white", colour = "white")) +
    theme(legend.position="none") + labs(x = TeX("Parasite density"), y = TeX("Exploration"), title = "") +
  annotate("text", x = 15, y = 0.45, label = TeX(paste0("$beta_{bs}$ = ", " 0.14 ", " 95%CI: -0.03, 0.31")), size =3, color = "#059687") + 
  annotate("text", x = 15, y = 0.47, label = TeX(paste0("$beta_{ces}$ = "," -0.09 ", " 95%CI: -0.27, 0.10")), size=3, color = "#8F05B3")
...
geom_point(mapping = aes(x = dens_ces, y = log_activity),color = "#9A6FA5")+
 geom_smooth(data = act_ces_dat, ggplot2::aes(x = ces, y = raw_act_ces), method =  "loess", formula = y~x, se = FALSE,lty = "solid", color = "#9A6FA5", size=1) +
  ...
  geom_point(mapping = aes(x = dens_bs, y = log_activity), color = "#6FA5A4") +
  ...
  draw_image("./img/blackspots.png", x = 28, y = -1.5, scale = 6) +
  draw_image("./img/cestodes.png", x = 28, y = -0.8, scale = 6) +
    theme(strip.background = element_rect(fill = "white", colour = "white")) +
    theme(legend.position="none") + labs(x = TeX(""), y = TeX("$Activity_{log_{2}}$"), title = "") +
      annotate("text", x = 15, y = 1.6, label = TeX(paste0("$beta_{bs}$ = ", " -0.22 ", " 95%CI: -0.40, -0.04 **")), size =3, color = "#059687") +
 annotate("text", x = 15, y = 1.8, label = TeX(paste0("$beta_{ces}$ = "," 0.01 ", " 95%CI: -0.18, 0.19")), size=3, color = "#8F05B3")
