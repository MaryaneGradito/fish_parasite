...
#Values in model 1.2 for logactivity-boldness
    ...
    plot(all_data$log_boldness, all_data$log_activity)
    abline(lm(all_data$log_activity ~ all_data$log_boldness), col = "red", lwd = 3)
    
    #Boldness and exploration average between trials
    plot(all_data$log_boldness, all_data$exploration)
    abline(lm(all_data$exploration ~ all_data$log_boldness), col = "red", lwd = 3)
  ...
  #Control
  plot(dat_C$log_activity, dat_C$exploration)
    abline(lm(dat_C$exploration ~ dat_C$log_activity), col = "red", lwd = 3)
   
  #Experimental
  plot(dat_E$log_activity, dat_E$exploration)
    abline(lm(dat_E$exploration ~ dat_E$log_activity), col = "red", lwd = 3)
