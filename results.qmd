...
#Boldness and activity average between trials
  ...
  p1<- ggplot(data = dat_C) + 
  geom_point(mapping = aes(x = log_boldness, y = log_activity, color = factor(ID_fish))) + 
  geom_smooth(mapping = aes(x = log_boldness, y = log_activity, color = "pink4")) + theme(legend.position="none") + ggtitle ("Control group")
  
  p2<- ggplot(data = dat_E) + 
  geom_point(mapping = aes(x = log_boldness, y = log_activity, color = factor(ID_fish))) + 
  geom_smooth(mapping = aes(x = log_boldness, y = log_activity, color = "red"))+ theme(legend.position="none") + ggtitle ("Experimental group")
  ...
  geom_smooth(mapping = aes(x = log_boldness, y = exploration, color = "pink4")) + theme(legend.position="none")
  
  p4<- ggplot(data = dat_E) + 
  geom_point(mapping = aes(x = log_boldness, y = exploration, color = factor(ID_fish))) + 
  geom_smooth(mapping = aes(x = log_boldness, y = exploration, color = "red")) + theme(legend.position="none")
   
    #Activity and exploration average between trials
  
  p5<- ggplot(data = dat_C) + 
  geom_point(mapping = aes(x = log_activity, y = exploration, color = factor(ID_fish))) +
  geom_smooth(mapping = aes(x = log_activity, y = exploration, color = "pink4")) + theme(legend.position="none")
  
  p6<- ggplot(data = dat_E) + 
  geom_point(mapping = aes(x = log_activity, y = exploration, color = factor(ID_fish))) +
  geom_smooth(mapping = aes(x = log_activity, y = exploration, color = "red")) + theme(legend.position="none")
