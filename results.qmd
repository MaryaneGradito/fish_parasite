...
# Lets create the predictions with the posterior for each variable. Here, we want to vary ces, but keep the other variables at the mean
  ...
  #For bs now
   newdat2 <- data.frame(intercept = 1, z_bs = seq(min(dat_parasite$z_bs), max(dat_parasite$z_bs), length.out = 100),
                        z_ces = 0,
                        z_bc = 0)
  ...
  # Second way to do this, but you need to know that this is producting PREDICTION INTERVALS not confidence intervals....which is why these are INSANELY wide.
