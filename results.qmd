...
scale_fill_manual(values = c("#D4A5DF", "#91E5E1","#FFF9C0")) +
geom_errorbar(data = dat1,aes(x = treatment,y = estimate, ymin= Lower_CI, ymax=Higher_CI), width=0.2, linewidth =1, color = "black", inherit.aes = FALSE)+
geom_point(data=dat1, mapping=aes(x= treatment, y= estimate), size=2.5, shape=21, fill = "white", inherit.aes = FALSE)+
labs(x = (""), 
...
annotate("text",  x = 1.5, y = 3.7, label = TeX(paste0("$Contrast_{U - I}$ = -0.47, CI = -0.72, -0.22**")), size =2.5) +
  geom_segment(aes(x = 1, xend = 3, y = 4, yend = 4), color = "black") +
annotate("text",  x = 2, y = 4.2, label = TeX(paste0("$Contrast_{U - C}$ = -1.11, CI = -1.70, -0.50**")), size =2.5) + 
geom_segment(aes(x = 2, xend = 3, y = 3, yend = 3), color = "black") +
annotate("text",  x = 2.5, y = 3.2, label = TeX(paste0("$Contrast_{C - I}$ = -0.64, CI = -1.24, -0.025**")), size =2.5) +
  annotate("text",  x = 1, y = -4.2, label = TeX(paste0("T1 & T2")), size =3.5) +
   annotate("text",  x = 2, y = -4.2, label = TeX(paste0("T3 & T4")), size =3.5) +
   annotate("text",  x = 3, y = -4.2, label = TeX(paste0("T3 & T4")), size =3.5)
...
geom_point(data=dat2, mapping=aes(x= treatment, y= estimate), size=2, shape=21, fill = "white", inherit.aes = FALSE)+
labs(x = "", 
y = "Surface covered (%)") +
theme_classic() +
...
annotate("text",  x = 1.5, y = 0.6, label = TeX(paste0("$Contrast_{U - I}$ = 0.42, CI = 0.18, 0.67**")), size =2.5) + 
 geom_segment(aes(x = 1, xend = 3, y = 0.64, yend = 0.64), color = "black") + 
annotate("text",  x = 2, y = 0.66, label = TeX(paste0("$Contrast_{U - C}$ = 1.13, CI =  0.67, 1.62**")), size =2.5) + 
  geom_segment(aes(x = 2, xend = 3, y = 0.53, yend = 0.53), color = "black") + 
annotate("text",  x = 2.5, y = 0.55, label = TeX(paste0("$Contrast_{C - I}$ = 0.34, CI =  0.30, 0.37**")), size =2.5) + 
  annotate("text",  x = 1, y = -0.05, label = TeX(paste0("T1 & T2")), size =3.5) +
   annotate("text",  x = 2, y = -0.05, label = TeX(paste0("T3 & T4")), size =3.5) +
   annotate("text",  x = 3, y = -0.05, label = TeX(paste0("T3 & T4")), size =3.5)
...
geom_point(data=dat3, mapping=aes(x= treatment, y= estimate), size=2, shape=21, fill = "white", inherit.aes = FALSE)+
labs(x = "Treatment", 
...
annotate("text",  x = 1.5, y = 3.8, label = TeX(paste0("$Contrast_{U - I}$ = -0.26, CI = -0.54, 0.02")), size =2.5) + 
  geom_segment(aes(x = 1, xend = 3, y = 4.2, yend = 4.2), color = "black") + 
annotate("text",  x = 2, y = 4.4, label = TeX(paste0("$Contrast_{U - C}$ = -0.22, CI = -0.69, 0.25")), size =2.5) + 
    geom_segment(aes(x = 2, xend = 3, y = 2.8, yend = 2.8), color = "black") + 
annotate("text",  x = 2.5, y = 3, label = TeX(paste0("$Contrast_{C - I}$ = 0.04, CI = -0.43, 0.53")), size =2.5) + 
  annotate("text",  x = 1, y = -4, label = TeX(paste0("T1 & T2")), size =3.5) +
   annotate("text",  x = 2, y = -4, label = TeX(paste0("T3 & T4")), size =3.5) +
   annotate("text",  x = 3, y = -4, label = TeX(paste0("T3 & T4")), size =3.5)
 ...
 #ggsave("./output/figures/fig2.2.png", plot = m4, width = 42, height = 15, units = "cm")
 ...
 geom_smooth(data = act_bc_c_dat, ggplot2::aes(x = bc, y = raw_act_bc_c), method =  "loess", formula = y~x, se = FALSE,lty = "solid", color = "#6FA5A4", size=1) +
  ...
  geom_smooth(data = act_bc_c_dat, ggplot2::aes(x = bc, y = raw_act_U95), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#6FA5A4", size=0.8)+
   theme_classic() +
    ...
    theme(legend.position="none") + labs(x = TeX("Body condition (g/cm)"), y = TeX("Distance swam$_{log_{2}}$ (cm)"), title = "")+
