...
```{r}
tab3 <- data.frame("Models" = c("Model 1", "Model 2","Model 3","Model 4","Model 5"),
"Shyness" = c("shyness ~ 1 + treatment + (-1 + treatment |q| ID_fish) + (1|cage), sigma ~ -1 + treatment", "shyness ~ 1 + treatment + (treatment |q| ID_fish) + (1 | cage), sigma ~ -1 + treatment","shyness ~ 1 + body condition + (1|ID_fish) + (1|cage)", "shyness ~ 1 + parasite density + body condition + (1|ID_fish) + (1|cage)",
"shyness ~ 1 + cestode density + black spot density + body condition + (1|ID_fish) + (1|cage)"),
"Activity" = c("activity ~ 1 + treatment + (-1 + treatment |q| ID_fish) + (1|cage), sigma ~ -1 + treatment","activity ~ 1 + treatment + (treatment |q| ID_fish) + (1 | cage), sigma ~ -1 + treatment",
"activity~ 1 + body condition + (1|ID_fish) + (1|cage)",
"activity ~ 1 + parasite density + body condition + (1|ID_fish) + (1|cage)",
"activity ~ 1 + cestode density + black spot density + body condition + (1|ID_fish) + (1|cage)"),
"Exploration" = c("exploration ~ 1 + treatment + (-1 + treatment |q| ID_fish) + (1|cage), sigma ~ -1 + treatment","exploration ~ 1 + treatment + (treatment |q| ID_fish) + (1 | cage), sigma ~ -1 + treatment", "exploration~ 1 + body condition+ (1|ID_fish) + (1|cage)"," exploration ~ 1 + parasite density + body condition + (1|ID_fish) + (1|cage)",
"exploration ~ 1 + cestode density + black spot density + body condition + (1|ID_fish) + (1|cage)"),
