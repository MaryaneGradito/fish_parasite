...
# See if syndromes differ in C and E
  ...
  #is it significant
   ...
   #is the difference significant
   pmcmc_act_exp<-pmcmc(bsyn_act_exp_E[,1] - bsyn_act_exp_C[,1], twotail = TRUE)
...
x2<- ggplot(data=dat_parasite)+
  geom_point(mapping = aes(x = z_bc, y = log_activity), shape = 16,color = pal)+
