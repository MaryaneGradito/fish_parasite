...
R_C_bolness <-  post_sd_C[,grep("logboldness", colnames(post_sd_C))]^2  / (post_sd_sig[,grep("b_sigma_logboldness_treatmentC", colnames(post_sd_sig))]^2 +
...
R_E_bolness <-  post_sd_E[,grep("logboldness", colnames(post_sd_E))]^2  / (post_sd_sig[,grep("b_sigma_logboldness_treatmentE", colnames(post_sd_sig))]^2 +
