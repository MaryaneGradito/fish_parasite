...
p1<-
  ...
  label = c("rb = -0.41, 95%CI =  -0.83, 0.11", "rb = -0.42, 95%CI = -0.85, 0.25"),
  treatment   = c("C","E")
)
...
geom_errorbar(data = dat_model,aes(x = treatment,y = estimate, xmin= Lower_CI, xmax=Higher_CI, group = trait == "logboldness"), width=0.4, inherit.aes = FALSE)+
...
annotate(geom = "text", label="p = ", x = 1.5, y = 6.7 )
