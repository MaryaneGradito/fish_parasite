...
```{r}
#| label: fig-fig1
#| fig-cap: Mean black spot and cestode density according per cage number (n=10) and geographic location on Lake Cromwell, Station de Biologie des Laurentides, Québec, Canada
#| out-width: 100%
#| fig-width: 8
#| fig-height: 8
