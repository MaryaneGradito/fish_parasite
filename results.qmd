...
#Contrast T and E
#int_bold_E_T<-(int_bold_E_num - int_bold_T_num)
#raw_int_b_E_T<-(int_bold_E_T * sd_boldness) + mean_boldness
#range(raw_int_b_E_T)
#raw_bold_T<- as.numeric(unlist(raw_int_b_E_T))
#raw_bold_T_mean<-mean(raw_int_b_E_T)
#blb_bold_T <- round(quantile(raw_int_b_E_T, c(0.025, 0.975))[1], 3)
#bub_bold_T <- round(quantile(raw_int_b_E_T, c(0.025, 0.975))[2], 3)
...
geom_segment(aes(x = 1, xend = 2, y = 3, yend = 3), color = "black") +
annotate("text",  x = 1.5, y = 3.2, label = TeX(paste0("$Contrast_{U - I}$ = -0.47, CI = -0.72, -0.22**")), size =2.5) +
  geom_segment(aes(x = 1, xend = 3, y = 3.5, yend = 3.5), color = "black") +
annotate("text",  x = 2, y = 3.7, label = TeX(paste0("$Contrast_{U - C}$ = -1.11, CI = -1.70, -0.50**")), size =2.5) + 
...
theme(legend.position = "none",
 legend.title = element_blank())+
geom_segment(aes(x = 1, xend = 2, y = 0.53, yend = 0.53), color = "black") +
annotate("text",  x = 1.5, y = 0.55, label = TeX(paste0("$Contrast_{U - I}$ = 0.42, CI = 0.18, 0.67**")), size =2.5) + 
 geom_segment(aes(x = 1, xend = 3, y = 0.58, yend = 0.58), color = "black") + 
annotate("text",  x = 2, y = 0.6, label = TeX(paste0("$Contrast_{U - C}$ = 1.13, CI =  0.67, 1.62**")), size =2.5) + 
...
annotate("text",  x = 2, y = 4.2, label = TeX(paste0("$Contrast_{U - C}$ = -0.22, CI = -0.69, 0.25")), size =2.5) + 
 ...
 ggsave("./output/figures/fig2.2.png", plot = m2, width = 42, height = 15, units = "cm")
