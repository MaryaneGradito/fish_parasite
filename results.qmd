...
#need to fit geom-smooth with my models
...
#Create data frame with posterior distribution from model2
  ...
  geom_segment(data =dat_slopes,
     ...
     geom_segment(data =dat_slopes,
      ...
      labs(y = TeX(paste0("Exploration", " ", "$\\beta_{id}$")),
           x = TeX(paste0("log Boldness", " ", "$\\beta_{id}$")))
...
k2<-ggplot(data= dat_slopes)+
  ...
  geom_segment(data =dat_slopes,
     ...
     geom_segment(data =dat_slopes,
      ...
      labs(y = TeX(paste0("log Activity", " ", "$\\beta_{id}$")),
           x = TeX(paste0("log Boldness", " ", "$\\beta_{id}$")))
...
k4<-ggplot(data= dat_slopes)+
  ...
  geom_segment(data =dat_slopes,
     ...
     labs(x = TeX(paste0("Boldness Behaviour", " (personality - intercept)")),
           y = TeX(paste0("Boldness", " Slope ", " $\\beta_{id}$")))
...
k6<-ggplot(data= dat_slopes)+
  ...
  geom_segment(data =dat_slopes,
     ...
     geom_segment(data =dat_slopes,
      ...
      labs(x = TeX(paste0("Activity Behaviour", " (personality - intercept)")),
           y = TeX(paste0("Activity", " Slope ", " $\\beta_{id}$")))
