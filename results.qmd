...
labels = c("A","B","C",""), ncol = 2)
 ...
 ggsave("./output/figures/fig2.png", plot = m, width = 25, height = 27, units = "cm")
...
ggsave("./output/figures/fig4.png", plot = p, width = 21, height = 22, units = "cm")
...
geom_errorbar(data=dat_r_b, mapping = aes(x = Treatment, ymin= Lower_CI, ymax=Higher_CI),width = 0,inherit.aes = FALSE) +
  scale_fill_manual(values = c("white","darkgrey")) + scale_x_discrete(limits=c("Uninfected","Uninfected1","Infected","Infected1"), labels = c("Uninfected","","Infected", ""))
...
```{r}
### table for model 4 looking at the effect of parasite on body condition
...
```{r}
### table for interactions between variables
...
gtsave(tab6, filename = "tab6.html")
```
