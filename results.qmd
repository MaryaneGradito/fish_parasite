...
```{r}
#| label: fig-fig2
#| fig-cap: Repeatability estimates and their 95% confidence intervals for the three behaviours (shyness,exploration and activity) of pumpkinseed sunfish (Lepomis gibbosus) measured overall and within each group (overall and uninfected, N=72; infected, N=60).
#| out-width: 100%
...
```{r}
#| label: fig-fig3
#| fig-cap: Correlation coefficients and their 95% confidence intervals for the three behaviours (shyness,exploration and activity) of pumpkinseed sunfish (Lepomis gibbosus) measured overall and within each group (overall and uninfected, N=72; infected, N=60).
#| out-width: 100%
