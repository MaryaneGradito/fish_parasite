...
p_value_bold<-pmcmc((R_C_boldness[,1]) - (R_E_boldness[,1])) # 0.95, meaning it's not different? 
...
#Boldness control
p_value_bold_C<-pmcmc(R_C_boldness[,1], null = 5)
#Boldness experimental
p_value_bold_E<-pmcmc(R_E_boldness[,1], null = 5)

#Exploration control
p_value_exp_C<-pmcmc(R_C_exploration[,1], 5)
#Exploration experimental
p_value_exp_E<-pmcmc(R_E_exploration[,1], 5)

#Activity control
p_value_act_C<-pmcmc(R_C_activity[,1], 5)
#Activity experimental
p_value_act_E<-pmcmc(R_E_activity[,1], 5)
