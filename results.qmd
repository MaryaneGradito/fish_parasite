...
blb_b_con_T <- round(quantile(int_b_con_num, c(0.025, 0.975))[1], 3)
bub_b_con_T <- round(quantile(int_b_con_num, c(0.025, 0.975))[2], 3)

int_exp_con_num_T<- as.numeric(unlist(int_exp_con_T))
mean_con_exp_T<-mean(int_exp_con_num_T)

blb_exp_con_T <- round(quantile(mean_con_exp_T, c(0.025, 0.975))[1], 3)
bub_exp_con_T <- round(quantile(mean_con_exp_T, c(0.025, 0.975))[2], 3)

int_act_con_num_T<- as.numeric(unlist(int_act_con_T))
mean_con_act_T<-mean(int_act_con_num_T)

blb_act_con_T <- round(quantile(mean_con_act_T, c(0.025, 0.975))[1], 3)
bub_act_con_T <- round(quantile(mean_con_act_T, c(0.025, 0.975))[2], 3)
...
annotate("text",  x = 3, y = 4.1, label = TeX(paste0("$Contrast_{U - C}$ = -0.22, $pMCMC_{\\alpha = 0.05}$ = 0.381")), size =2.5)
 ...
 ggsave("./output/figures/fig2.png", plot = m, width = 42, height = 15, units = "cm")
 ...
 geom_smooth(data = act_bc_c_dat, ggplot2::aes(x = z_bc, y = summ_act_bc_c), method =  "loess", formula = y~x, se = FALSE,lty = "solid", color = "#472a7a", size=1) +
  ...
  geom_smooth(data = act_bc_c_dat, ggplot2::aes(x = z_bc, y = summ_actU95_bc_c), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#472a7a", size=0.8)+
   theme_classic() +
    ...
    theme(legend.position="none") + labs(x = TeX("Body condition (g/cm)"), y = TeX("$Activity_{log_{2}}$"), title = "")+
...
#bold_pl_dat <- cbind(newdat5, summ_bold_pl, summ_boldL95_pl, summ_boldU95_pl)
 ...
 # pred_ces <- predict(model7, re_formula = NA, newdata = newdat)
  ...
  geom_point(mapping = aes(x = z_ces, y = z_log_boldness), color = "#9E60AE")+
  geom_smooth(data = boldness_ces_dat, ggplot2::aes(x = z_ces, y = summ_bold_ces), method =  "loess", formula = y~x, se = FALSE,lty = "solid", color = "#9E60AE", size=1) +
  geom_smooth(data = boldness_ces_dat, ggplot2::aes(x = z_ces, y = summ_boldL95_ces), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#9E60AE", size=0.8)+
  geom_smooth(data = boldness_ces_dat, ggplot2::aes(x = z_ces, y = summ_boldU95_ces), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#9E60AE", size=0.8) + 
    geom_point(mapping = aes(x = z_bs, y = z_log_boldness), color = "#3CBBAE")+
  geom_smooth(data = boldness_bs_dat, ggplot2::aes(x = z_bs, y = summ_bold_bs), method =  "loess", formula = y~x, se = FALSE,lty = "solid", color = "#3CBBAE", size=1) +
  geom_smooth(data = boldness_bs_dat, ggplot2::aes(x = z_bs, y = summ_boldL95_bs), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#3CBBAE", size=0.8)+
  geom_smooth(data = boldness_bs_dat, ggplot2::aes(x = z_bs, y = summ_boldU95_bs), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#3CBBAE", size=0.8)+
 ...
 # geom_smooth(data = bold_pl_dat, ggplot2::aes(x = z_pl, y = summ_boldU95_pl), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#A2A2A2", size=0.8)+
  ...
  draw_image("./img/blackspots.png", x = 3, y = -1.2, scale = 0.8)+
    ...
    theme(legend.position="none") + labs(x = TeX(""), y = TeX("$Shyness_{log_{2}}$"), title = "") +
      annotate("text", x = 1.5, y = 3.2, label = TeX(paste0("$beta_{bs}$ = ", " -0.08 ", " 95%CI: -0.28, 0.12")), size =3, color = "#059687") + 
  annotate("text", x = 1.5, y = 3, label = TeX(paste0("$beta_{ces}$ = "," 0.10 ", " 95%CI: -0.11, 0.30")), size=3, color = "#8F05B3")
...
n2<-ggplot(data=dat_parasite)+
  geom_point(mapping = aes(x = z_ces, y = z_exploration), color = "#9E60AE")+
 geom_smooth(data = exp_ces_dat, ggplot2::aes(x = z_ces, y = summ_exp_ces), method =  "loess", formula = y~x, se = FALSE,lty = "solid", color = "#9E60AE", size=1) +
  geom_smooth(data = exp_ces_dat, ggplot2::aes(x = z_ces, y = summ_expL95_ces), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#9E60AE", size=0.8)+
  geom_smooth(data = exp_ces_dat, ggplot2::aes(x = z_ces, y = summ_expU95_ces), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#9E60AE", size=0.8)+
  geom_point(mapping = aes(x = z_bs, y = z_exploration), color = "#3CBBAE") +
   geom_smooth(data = exp_bs_dat, ggplot2::aes(x = z_bs, y = summ_exp_bs), method =  "loess", formula = y~x, se = FALSE,lty = "solid", color = "#3CBBAE", size=1) +
  geom_smooth(data = exp_bs_dat, ggplot2::aes(x = z_bs, y = summ_expL95_bs), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#3CBBAE", size=0.8)+
  geom_smooth(data = exp_bs_dat, ggplot2::aes(x = z_bs, y = summ_expU95_bs), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#3CBBAE", size=0.8)+
  ...
  draw_image("./img/blackspots.png", x = 2.8, y = 0.2, scale = 0.8)+
    ...
    theme(legend.position="none") + labs(x = TeX("Parasite density"), y = TeX("Exploration"), title = "") +
      annotate("text", x = 1.5, y = 3.2, label = TeX(paste0("$beta_{bs}$ = ", " 0.14 ", " 95%CI: -0.03, 0.31")), size =3, color = "#059687") + 
  annotate("text", x = 1.5, y = 3, label = TeX(paste0("$beta_{ces}$ = "," -0.09 ", " 95%CI: -0.27, 0.10")), size=3, color = "#8F05B3")
...
geom_point(mapping = aes(x = z_ces, y = z_log_activity),color = "#9E60AE")+
 geom_smooth(data = act_ces_dat, ggplot2::aes(x = z_ces, y = summ_act_ces), method =  "loess", formula = y~x, se = FALSE,lty = "solid", color = "#9E60AE", size=1) +
  geom_smooth(data = act_ces_dat, ggplot2::aes(x = z_ces, y = summ_actL95_ces), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#9E60AE", size=0.8)+
  geom_smooth(data = act_ces_dat, ggplot2::aes(x = z_ces, y = summ_actU95_ces), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#9E60AE", size=0.8)+
  geom_point(mapping = aes(x = z_bs, y = z_log_activity), color = "#3CBBAE") +
   geom_smooth(data = act_bs_dat, ggplot2::aes(x = z_bs, y = summ_act_bs), method =  "loess", formula = y~x, se = FALSE,lty = "solid", color = "#3CBBAE", size=1) +
  geom_smooth(data = act_bs_dat, ggplot2::aes(x = z_bs, y = summ_actL95_bs), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#3CBBAE", size=0.8)+
  geom_smooth(data = act_bs_dat, ggplot2::aes(x = z_bs, y = summ_actU95_bs), method =  "loess", formula = y~x, se = FALSE,lty = "dashed", color = "#3CBBAE", size=0.8)+
   theme_classic() +
  ...
  draw_image("./img/blackspots.png", x = 2.8, y = -1.5, scale = 0.8)+
    draw_image("./img/cestodes.png", x = 2.8, y = -0.6, scale = 0.8) +
    theme(strip.background = element_rect(fill = "white", colour = "white")) +
    theme(legend.position="none") + labs(x = TeX(""), y = TeX("$Activity_{log_{2}}$"), title = "")+
      annotate("text", x = 1, y = 2.2, label = TeX(paste0("$beta_{bs}$ = ", " -0.22 ", " 95%CI: -0.40, -0.04 **")), size =3, color = "#059687") +
  annotate("text", x = 1, y = 2, label = TeX(paste0("$beta_{ces}$ = "," 0.01 ", " 95%CI: -0.18, 0.19")), size=3, color = "#8F05B3")
...
```{r}
#| label: fig-fig5
#| fig-cap: (A) Correlation of slopes of change between traits (shyness, exploration and activity) and their standard error in pumpkinseed sunfish (Lepomis gibbosus) after an experimental infection. Blue dots are individuals, n = 60; blue lines are standard errors; red lines are the mean behaviourz. Above the red line is a positive change in the slope, below is a negative change. All variables are z-scaled. (B) Correlation between the slope of change of traits and their average behaviour (shyness, exploration and activity) and their standard error in pumpkinseed sunfish (Lepomis gibbosus) after an experimental infection. Gold dots are individuals, n = 60; gold lines are the standard errors; red lines are the intercept behaviours. On the x-axis; above the red line is above the average behaviour and below the red line is below average. On the y-axis; above the red line is a positive change in the slope of a trait, below is a negative change. All variables are z-scaled.
#| out-width: 100%
#| fig-width: 7
#| fig-height: 4
...
ggsave("./output/figures/fig6.png", plot = w1, width = 18, height = 16, units = "cm")
...
m1
ggsave("./output/figures/fig7.png", plot = m1, width = 18, height = 16, units = "cm")
