#Import dataset.
Chem_C2<-read.csv2("./output/DATA_C2_Chemical_test.csv", na.strings = c("NA"), header = TRUE) #na.strings to interpret character as NA values
Shoal_C2<-read.csv2("./output/DATA_C2_StimuliShoal.csv", na.strings = c("NA"), header = TRUE)
