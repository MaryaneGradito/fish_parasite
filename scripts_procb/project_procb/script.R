...
### I can't calculate the adjusted mass for when they arrive in the lab and before the caging experiment, since we don't know their internal parasite loads yet (assume none)
...
#################################
# Compare R in infected and uninfected treatments
#################################
